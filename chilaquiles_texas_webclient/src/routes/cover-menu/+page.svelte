...
>
    <article id="txc-cm-content" class="txc-common-main-content-layout">
        <p class="txc-cm-content-p main-content-paragraph">
            ...
            after chilaquiles for a reason.
        </p>
        <p class="txc-cm-content-p main-content-paragraph">
            Bold, soulful, made close to home,<br/>
            and never tied to a schedule.
        </p>
        <p class="txc-cm-content-p main-content-paragraph">
            Everything we serve shares that spirit:<br/>
            comfort, flavor, memory,<br/>
